...
public class test {
    ...
    void reverseString (){
        String str = "Hello";
        test ReverseStringUsingStringBuilder = null;
    ...
    private Object removeDuplicateChars(String str) {
    }
    ...
    private Object concatenateStrings(String[] words) {
    }
    ...
    private Object findRotationPoint(int[] rotatedArray) {
    }
